...
export const Footer = () => {
    return (<>
        ...
        <svg width="30" height="30" fill="none" className="socialicon" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
