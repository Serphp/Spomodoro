export const Footer = () => {
    return (<>
        ...
        <a href="https://twitter.com/Serphp" target="_blank" rel="noopener noreferrer">
        <svg width="30" height="30" fill="none" className="socialicon" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://github.com/Serphp" target="_blank" rel="noopener noreferrer">
        <svg width="30" height="30" fill="none" className="socialicon" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://www.linkedin.com/in/bryaninit/" target="_blank" rel="noopener noreferrer">
        <svg width="30" height="30" fill="none" className="socialicon" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
